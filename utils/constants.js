...
export const productosMercado = [
    ...
    { nombre: 'Escudo de roble', precio: 120, rareza: 'raro', tipo: 'armadura', bonus: { defensa: 14 }, imagen: 'img/shield.png' },
    ...
    { nombre: 'Placas dracónicas', precio: 180, rareza: 'épico', tipo: 'armadura', bonus: { defensa: 28 }, imagen: 'img/helmets.png' },
